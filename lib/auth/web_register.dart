...
class web_register extends StatefulWidget {
   final String Code;
   web_register({Key? key, required  this.Code}) : super(key: key);

  @override
  State<web_register> createState() => _web_registerState();
}

class _web_registerState extends State<web_register> {
  ...
  bool loading=false;
harsh(){
  referal.text = widget.Code.toString();
}
  bool Verify =false;
  bool Verified =false;
 ...
 //   final String referal = ModalRoute.of(context)!.settings.arguments as String;
