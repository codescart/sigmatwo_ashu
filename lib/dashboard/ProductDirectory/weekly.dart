...
import 'package:Sigma/dashboard/ProductDirectory/ambani2view.dart';
import 'package:Sigma/main.dart';
import 'package:Sigma/product/ProductController/product2controller.dart';
...
class Tk_Product extends StatefulWidget {
   Tk_Product({Key? key}) : super(key: key);

  @override
  State<Tk_Product> createState() => _Tk_ProductState();
}

class _Tk_ProductState extends State<Tk_Product> {
  ...
  Future<List<Product2Controller>> qwe()  async {
    ...
    final response = await http
        .get(Uri.parse(Apiconst.ProductAdaniurl2+'$userid'));
