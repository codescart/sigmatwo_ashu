...
class ambani2view extends StatefulWidget {
  final Product2Controller view;
  const ambani2view({required this.view});

  @override
  State<ambani2view> createState() => _ambani2viewState();
}

class _ambani2viewState extends State<ambani2view> {
  @override
